...
public class DBWorkload {
  ...
  public static void main(String[] args) throws Exception {
    ...
    String zipConstantArg = "0.99";
    if (argsLine.hasOption('z')) {
      zipConstantArg = argsLine.getOptionValue('z');
    }

    double zipConstant = Double.parseDouble(zipConstantArg);
    ...
    for (String plugin : targetList) {
      ...
      wrkld.setZipConstant(zipConstant);
  ...
  private static Options buildOptions(XMLConfiguration pluginConfig) {
    ...
    options.addOption("z", "zipfian-constant", true, "Zipfian Constant");
    return options;
  }
